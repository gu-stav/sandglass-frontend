define(function(){
  return '<li class="timeline__item">' +
         ...
         '<h2 class="timeline__headline"><span class="timeline__activity" contenteditable>{{activity}}</span> @ <span contenteditable class="timeline__project">{{project}}</span></h2>' +
         '</div><p class="timeline__description" contenteditable>{{description}}</li>'
});